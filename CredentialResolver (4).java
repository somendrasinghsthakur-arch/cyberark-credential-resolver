...
public class CredentialResolver implements IExternalCredential {
	...
	private String safeFolder = "root";		// The Safe folder to use as specified in the MID config.xml file (must match folder name in CyberArk)
	private String safeName = "01_02_SVC_1101235018-P	";		// The Safe name to use as specified in the MID config.xml file (must match safe name in CyberArk)
	private String safeAppID = "1101235018-P"; 		// The App-ID used when connecting to CyberArk (can be overridden in the config.xml file)
	private String safeTimeout = "5";	// The vault (server) response timeout in seconds to use as specified in the MID config.xml file
